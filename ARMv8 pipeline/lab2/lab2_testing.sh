...
declare -a file_list=("step1-a-input.x" "step1-b-input.x"  "step2-a-input.x"  "step2-b-input.x"  "step3-input.x"
	"more-inputs.x" "more-inputs2.x" "more-inputs3.x" "final_test.x" "final_test-2.x" "final-test-file.x" "final-test-file2.x")

#declare -a file_list=("final-test-file2.x")
#declare -a file_list=("more-inputs.x")
