...
declare -a file_list=(#"loop1.x" "loop2.x" "loop3.x" "step1-a-input.x" "step1-b-input.x"
					#"step2-a-input.x" "step2-b-input.x" "step3-input.x"
					#"final_test.x" "final_test-2.x" "final-test-file.x" "final-test-file2.x"
					#"more-inputs.x" "more-inputs2.x" "more-inputs3.x"
					#"jackie_test1.x" "jackie_test2.x" "jackie_test3.x"
					"br_same.x" "ld.x" "cancel_req.x" "st_loop.x")
					#"loop2.x")
					#"full_dset.x")
					#"edgecase.x" "cbz_cbnz.x") 
