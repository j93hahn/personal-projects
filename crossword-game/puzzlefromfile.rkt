...
;; ====== sample xwp files
(define test_file1 "nytimes-mini-nov-27-2020.xwp")
(define test_file2 "nytimes-jan-25-2016.xwp")
(define joshua_test "personal_test.xwp")
...
;; (puzzle-from-file test_file1)
;; (puzzle-from-file test_file2)
;; (puzzle-from-file joshua_test)
